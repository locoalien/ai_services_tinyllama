...
app = FastAPI(title='AI Servicess by NewInntech S.A.S', description=docs.desc, version=docs.version)
...
def read_root():
    return {"message": "Servicios AI de Grupo Nutresa en colaboracion con New Inntech S.A.S!"}


@app.on_event("startup")
async def startup():
    logger.info("AI SAAS PLATFORM")
